...
public class UrlNetContext {

    public static final UrlNetContext instance = new UrlNetContext();
    private SharedPreferences prefRetrofit;
    private SharedPreferences.Editor prefRetrofitEditor;
    Gson gson = new Gson();

    public static UrlNetContext getInstance() {
        return instance;
    }
    ...
    private String BASE_URL = "http://push.lachongmedia.vn/";
