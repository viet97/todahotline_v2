...
//				addToContacts.setVisibility(View.VISIBLE);
    ...
    class HistoryDetailAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            String[] listStringDuration = LinphoneActivity.instance.secondsToDisplayableString(callLog.getDuration()).split(":");
            int hours = Integer.parseInt(listStringDuration[0]);
            int minute = Integer.parseInt(listStringDuration[1]);
