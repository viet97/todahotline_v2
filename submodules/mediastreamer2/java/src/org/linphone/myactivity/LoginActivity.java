...
public class LoginActivity extends Activity {
    ...
    public static String DEFAULT_BASE = "14.177.238.89:8666";
...
//                            SipHome.mViewPager.refreshDrawableState();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            spinnerIdct = (Spinner) findViewById(R.id.spinner_idct);
...
//            }
            ...
            if (saveLogin) {
                ...
                spinnerIdct.setSelection(loginPreferences.getInt("server", 0));
...
//                getBaseContext().getContentResolver().delete(ContentUris.withAppendedId(SipProfile.ACCOUNT_ID_URI_BASE, 1), null, null);
                if (cbx_remember.isChecked()) {
                    ...
                    loginEditor.putInt("server",spinnerIdct.getSelectedItemPosition());
                    loginEditor.apply();
                } else {
                    loginEditor.clear();
                    loginEditor.apply();
                ...
                if (!isNetworkAvailable(getBaseContext())) {
                    ...
                    loginURL = KEY_FUNC_URL
                            + "token="
                            + "&idct=" +spinnerAdapter.getItem(spinnerIdct.getSelectedItemPosition())
